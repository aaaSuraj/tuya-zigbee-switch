...
| -- | -- | -- | -- | -- | :--: | :-------------------------------------- | :------------------------------ | ----: | ------: | :----- |
| 🟨 | ✔️ | 🇸 | 🔌 | 🛜 | **TL** | `_TZ3000_1nenkvye` <br> `TS0004` | [Tuya 4-gang switch](https://www.zigbee2mqtt.io/devices/TS0004.html) |   | [`#181`](https://github.com/romasku/tuya-zigbee-switch/issues/181) | Needs netled on A0 | 
